...
public class SpringJPABootstrap implements ApplicationListener<ContextRefreshedEvent>{
	...
	public void loadCustomers() {
		...
		customer.getBillingAddress().setAddressLine1("Spokojna 1");
		customer.getBillingAddress().setAddressLine2("Niemila 1");
		customer.getBillingAddress().setCity("Warszawa1");
		customer.setEmail("test1@test.pl");
		customer.setFirstName("Alojzy1");
		customer.setLastName("Ags");
		customer.setPhoneNumber("620111111");
		customer.getBillingAddress().setState("mazowieckie");
		customer.getBillingAddress().setZipCode("00-111");
		customerService.saveOrUpdate(customer);
		
		Customer customer2 = new Customer();
		customer2.setBillingAddress(new Address());
		customer2.getBillingAddress().setAddressLine1("Spokojna 2");
		customer2.getBillingAddress().setAddressLine2("Niemila 2");
		customer2.getBillingAddress().setCity("Warszawa2");
		...
		customer2.getBillingAddress().setState("mazowieckie");
		customer2.getBillingAddress().setZipCode("00-222");
		customerService.saveOrUpdate(customer2);
		
		Customer customer3 = new Customer();
		customer3.setBillingAddress(new Address());
		customer3.getBillingAddress().setAddressLine1("Spokojna 3");
		customer3.getBillingAddress().setAddressLine2("Niemila 3");
		customer3.getBillingAddress().setCity("Warszawa3");
		...
		customer3.getBillingAddress().setState("mazowieckie");
		customer3.getBillingAddress().setZipCode("00-333");
